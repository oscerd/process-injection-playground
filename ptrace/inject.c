...
int main(int argc, const char *argv[]) {
    if (argc < 2) {
        fprintf(stderr, "Usage:\n\t./inject PID\n\n"
                "\tPID - Process ID of the process to inject code.\n");
        exit(EXIT_FAILURE);
    }
    ...
    fprintf(stdout, "-> Attach to Process %ld.\n", victim_pid);
    ...
    fprintf(stdout, "-> Injecting shell code at address 0x%lx.\n", address);
    ...
    fprintf(stdout, "-> Jump to shell code.\n");
    ...
    fprintf(stdout, "-> Successfuly injected and jumped to shell code.\n");
